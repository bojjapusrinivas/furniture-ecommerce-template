...
function LogIn() {
  ...
  <Form className='aut-form bg-dark p-3 text-center ' >
      <FormGroup className='my-1 w-100'>
        <input type='text' placeholder='Enter Email' value={email} onChange={(e) => e.target.value} className=' w-100 p-2'/>
      </FormGroup>

      <FormGroup className='my-1  w-100'>
        <input type='Password' placeholder='Enter Password' value={password} onChange={(e) => e.target.value} className=' w-100 p-2'/>
      </FormGroup>
